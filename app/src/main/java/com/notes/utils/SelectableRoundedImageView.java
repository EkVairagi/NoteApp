...
public class SelectableRoundedImageView extends AppCompatImageView {
    ...
    public SelectableRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mLeftTopCornerRadius = a.getDimensionPixelSize(R.styleable.SelectableRoundedImageView_left_top_corner_radius, 0);
        mRightTopCornerRadius = a.getDimensionPixelSize(R.styleable.SelectableRoundedImageView_right_top_corner_radius, 0);
        mLeftBottomCornerRadius = a.getDimensionPixelSize(R.styleable.SelectableRoundedImageView_left_bottom_corner_radius, 0);
        mRightBottomCornerRadius = a.getDimensionPixelSize(R.styleable.SelectableRoundedImageView_right_bottom_corner_radius, 0);
        ...
        mBorderWidth = a.getDimensionPixelSize(
                R.styleable.SelectableRoundedImageView_border_width, 0);
        if (mBorderWidth < 0) {
            throw new IllegalArgumentException("border width cannot be negative.");
        }

        mBorderColor = a
                .getColorStateList(R.styleable.SelectableRoundedImageView_border_color);
        if (mBorderColor == null) {
            mBorderColor = ColorStateList.valueOf(DEFAULT_BORDER_COLOR);
        }

        isOval = a.getBoolean(R.styleable.SelectableRoundedImageView_oval, false);
        a.recycle();
    ...
    private Drawable resolveResource() {
        ...
        if (mResource != 0) {
            try {
                ...
                Log.e("TAG", "Unable to find resource: " + mResource, e);
                // Don't try again.
                mResource = 0;
            }
        }
